...
One of the most challenging aspects was understanding and implementing beta-reduction. In the `Application` class, the process required ensuring that function abstractions were correctly applied to their arguments and appropriately simplified. This involved a deep dive into the principles of function application and beta-reduction in λ-calculus. Through trial and error, I managed to develop a method that accurately performs beta-reduction in various scenarios. This not only enhanced my problem-solving skills but also deepened my understanding of the core concepts of λ-calculus.
